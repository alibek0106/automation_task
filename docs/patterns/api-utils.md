...
| File | Description |
|------|-------------|
| [ApiClient.ts](utils/ApiClient.ts) | Thin HTTP wrapper |
| [BaseRequestBuilder.ts](tests/api/builders/BaseRequestBuilder.ts) | Base builder class |
| [StatusCode.ts](tests/api/constants/StatusCode.ts) | HTTP status codes |
| [api.fixture.ts](tests/fixtures/api.fixture.ts) | API fixtures |
| [parseResponse.ts](utils/parseResponse.ts) | Schema validation helpers |
| [matchers.ts](utils/matchers.ts) | Custom Playwright matchers |